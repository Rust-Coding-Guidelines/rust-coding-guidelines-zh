...
- [编程实践](./safe-guides/coding_practice.md)
    ...
    - [基础数据类型](./safe-guides/coding_practice/primitives.md)
        - [单元类型](./safe-guides/coding_practice/primitives/unit.md)
        - [指针](./safe-guides/coding_practice/primitives/pointer.md)
        - [引用](./safe-guides/coding_practice/primitives/ref.md)
        - [数组](./safe-guides/coding_practice/primitives/array.md)
        - [布尔](./safe-guides/coding_practice/primitives/bool.md)
        - [字符](./safe-guides/coding_practice/primitives/char.md)
        - [整数](./safe-guides/coding_practice/primitives/int.md)
        - [浮点数](./safe-guides/coding_practice/primitives/float.md)
        - [切片](./safe-guides/coding_practice/primitives/slice-and_str.md)
        - [元组](./safe-guides/coding_practice/primitives/tuple.md)
    - [复合数据类型](./safe-guides/coding_practice/composite.md)
        - [结构体](./safe-guides/coding_practice/composite/struct.md)
        - [枚举体](./safe-guides/coding_practice/composite/enum.md)
        - [联合体](./safe-guides/coding_practice/composite/union.md)
    - [字符串](./safe-guides/coding_practice/strings.md)
    - [集合类型](./safe-guides/coding_practice/collections.md)
    ...
    - [Unsafe Rust](./safe-guides/coding_practice/unsafe_rust.md)
        - [安全抽象规范](./safe-guides/coding_practice/unsafe_rust/safe_abstract.md)
